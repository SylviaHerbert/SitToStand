...
gif_out_filename = './visualize_STS_BRS_3.gif'; %v_goal.gif';   %Setup filename for gif
avi_out_filename = './visualize_STS_BRS_3.avi'; %v_goal.avi';
...
subplot(1,2,2)
[g2D,data2D]=proj(g3D,data3D,[0 1 0],hipAngSlice); 
