function hamValue = pendulum6DHam(t, data, deriv, schemeData)
...
checkStructureFields(schemeData, 'grid',  'R1', 'R2','R3',...
  'M1','M2','M3','L1','L2','T1Max','T2Max','T3Max');
...
tau1_multiplier =   ((p2*ddt1_num_tau1/ddt1_denom)...
      -(p4*ddt2_num_tau1/ddt2_denom) ... 
      -(p6*ddt3_num_tau1/ddt3_denom));
tau2_multiplier = ((p2*ddt1_num_tau2/ddt1_denom) ...
      -(p4*ddt2_num_tau2/ddt2_denom)...
     -(p6*ddt3_num_tau2/ddt3_denom));
tau3_multiplier = ((p2*ddt1_num_tau3/ddt1_denom)  ...
      -(p4*ddt2_num_tau3/ddt2_denom)...
      -(p6*ddt3_num_tau3/ddt3_denom));
extra_argravuments = p1v1 + p3v2 + p5v3 +...
    p2*(ddt1_num_general/ddt1_denom) + ...
    p4*(-ddt2_a_num_general/ddt2_denom)+...
    p4*(ddt2_b_num_general/ddt2_denom) + ...
    p6*(-ddt3_a_num_general/ddt3_denom)+...
    p6*ddt3_b_num_general/ddt3_denom +...
    p6*ddt3_c_num_general/ddt3_denom ;
    
    
  
hamValue = (tau1_multiplier >0)*(tau1_multipler)*(-T1Max)+...
  (tau1_multiplier <= 0)*(tau1_multiplier)*(T1Max)+...
  (tau2_multiplier >0)*(tau2_multipler)*(-T2Max)+...
  (tau2_multiplier <= 0)*(tau2_multiplier)*(T2Max)+...
  (tau3_multiplier >0)*(tau3_multipler)*(-T3Max)+...
  (tau3_multiplier <= 0)*(tau3_multiplier)*(T3Max)+...
  extra_argravuments;
