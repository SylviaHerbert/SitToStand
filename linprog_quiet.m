function [x,fval,exitflag,output,lambda]=linprog_quiet(f,A,B,Aeq,Beq,lb,ub,x0,options)
...
if strcmpi(Algorithm,algIP)   
    ...
    [x,fval,lambda,exitflag,output] = lipsol_quiet(f,A,B,Aeq,Beq,lb,ub,options,defaultopt,computeLambda);
    a = 1;
